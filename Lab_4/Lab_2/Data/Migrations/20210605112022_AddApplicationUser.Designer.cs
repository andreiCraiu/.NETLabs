...
namespace Lab_2.Data.Migrations
{
    ...
    [Migration("20210605112022_AddApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lab_2.Models.Task", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("UserTaskAssignedID")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.HasIndex("UserTaskAssignedID");
            ...
            modelBuilder.Entity("Lab_2.Models.Task", b =>
                {
                    b.HasOne("Lab_2.Models.UserTaskAssigned", null)
                        .WithMany("Tasks")
                        .HasForeignKey("UserTaskAssignedID");
                });

            modelBuilder.Entity("Lab_2.Models.UserTaskAssigned", b =>
                {
                    b.HasOne("Lab_2.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
